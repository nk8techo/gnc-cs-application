...
WHERE (((qurReportingBase.[Project Manager])=[Project Manager:]) AND ((qurReportingBase.Open) Between [Starting Date:] And [Ending Date:]))
...
HAVING (((qurReportingBase.Category)<>"P"));
