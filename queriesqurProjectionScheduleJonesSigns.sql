...
WHERE (((qurReportingBase.Category)="C" Or (qurReportingBase.Category)="N" Or (qurReportingBase.Category)="R" Or (qurReportingBase.Category)="P") AND ((qurReportingBase.Open) Between Date() And Date()+120) AND ((qurReportingBase.[Sign Vendor])="JS"));
