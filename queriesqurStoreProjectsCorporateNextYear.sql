...
WHERE (((qurReportingBase.[Corporate or Franchise])="C") AND ((Year([Open]))=Year(Date())+1) AND ((qurReportingBase.Category)="C" Or (qurReportingBase.Category)="N" Or (qurReportingBase.Category)="R"));
