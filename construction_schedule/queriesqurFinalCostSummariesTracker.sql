...
WHERE (((qurReportingBase.[Corporate or Franchise])="C") AND ((IIf([Corporate or Franchise]="C",[Final Cost Due],([Final Cost Due]-15)))<=Date()+45) AND ((qurReportingBase.[Project Status])="A") AND ((tblFinancials.[Final Cost]) Is Null))
ORDER BY IIf([Corporate or Franchise]="C",[Final Cost Due],([Final Cost Due]-15));
