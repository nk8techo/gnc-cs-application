...
WHERE (((qurReportingBase.Open) Between Date() And Date()+120) AND ((qurReportingBase.[HVAC Vendor])="CARRIER" Or (qurReportingBase.[HVAC Vendor])="GCCU") AND ((qurReportingBase.[HVAC Required])=True));
