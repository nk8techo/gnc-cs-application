...
WHERE (((Year([Open]))=Year(Date())) AND ((qurCoreProjectInformationPanel.[Project Status])="A") AND ((qurCoreProjectInformationPanel.Category)="N" Or (qurCoreProjectInformationPanel.Category)="R" Or (qurCoreProjectInformationPanel.Category)="C"))
