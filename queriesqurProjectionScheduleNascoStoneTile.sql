...
WHERE (((qurReportingBase.Location)="M") AND ((qurReportingBase.Category)<>"P") AND ((qurReportingBase.[Store Format])="D") AND ((qurReportingBase.Open) Between Date() And Date()+120));
